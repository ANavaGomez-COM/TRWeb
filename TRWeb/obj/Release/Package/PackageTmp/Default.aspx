...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <%--  <script type="text/javascript">
     NOTE: This URL is now being called from runEpaymentProgram.bat on the ERPBIZTALK server.
    ...
    <p>
        ...
        <asp:Label ID = "lblTotal" runat="server" Text="Enter Total:"></asp:Label>
        <asp:TextBox ID = "tbTotal" runat="server"></asp:TextBox>
        <asp:Label ID = "lblCount" runat="server" Text="Enter Count:"></asp:Label>
    ...
    <p>
        ...
        <asp:Table ID="tblFileNames" runat="server" CellPadding="5" HorizontalAlign="Left" Width="500px">
            ...
            <asp:TableRow>
                <asp:TableCell><asp:Label ID="lblCashCode" runat="server" Text="Work Source Code" Width="150px"></asp:Label></asp:TableCell>
                <asp:TableCell>
