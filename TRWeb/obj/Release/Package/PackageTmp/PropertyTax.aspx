<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="PropertyTax.aspx.cs" Inherits="TRWeb.PropertyTax" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div>
    <asp:Table ID="tblPropertyTax" runat="server" CellPadding="5" 
        HorizontalAlign="Left" Width="530px">
        <asp:TableRow>
            <asp:TableCell><asp:Label ID="lblUnitID" runat="server" Text="Unit ID" Width="150px"></asp:Label></asp:TableCell>
            <asp:TableCell><asp:TextBox ID="txtUnitID" runat="server" Width="350px"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell><asp:Label ID="lblClientID" runat="server" Text="Client ID" Width="150px"></asp:Label></asp:TableCell>
            <asp:TableCell><asp:TextBox ID="txtClientID" runat="server" Width="350px"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell><asp:Label ID="lblClientName" runat="server" Text="Client Name" Width="150px"></asp:Label></asp:TableCell>
            <asp:TableCell><asp:TextBox ID="txtClientName" runat="server" Width="350px"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell><asp:Label ID="lblClientAddress" runat="server" Text="Client Address" Width="150px"></asp:Label></asp:TableCell>
            <asp:TableCell><asp:TextBox ID="txtClientAddress" runat="server" Width="350px"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
    ...
    <asp:TextBox ID="txtResult" runat="server" Height="210px" TextMode="MultiLine" 
        ...
        <asp:GridView ID="grdResult" runat="server" Width="915px" ShowFooter="True"
            onselectedindexchanged="grdResult_SelectedIndexChanged" AutoGenerateSelectButton="True"  OnRowCreated="grdResult_OnRowCreated">
